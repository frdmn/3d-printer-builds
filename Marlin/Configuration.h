...
#define STRING_CONFIG_H_AUTHOR "frdmn" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Marlin " DETAILED_BUILD_VERSION " ("  __DATE__ " " __TIME__ ")"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 921.70 }
...
#define X_BED_SIZE 220 // tmp because of WIP H2 V2S mount that that is jamming into some screw
#define Y_BED_SIZE 214 // reduced because of Y tensioner
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MAX_POS - 10), 45 }
